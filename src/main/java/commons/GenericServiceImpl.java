...
public abstract class GenericServiceImpl <I, O> implements GenericServiceAPI<I, O> {
    ...
    public O get(String id) throws Exception {
        ...
        if (document.exists()) {
            ...
            setProperty(object, "id", document.getId());
            return object;
        }
        return null;
    }
    ...
    public List<O> getAll() throws Exception {
        ...
        for (QueryDocumentSnapshot doc : documents) {
            ...
            setProperty(object, "id", doc.getId());
        }
        return result;
    }

    protected abstract void setProperty(O object, String string, String id);
    ...
    public abstract CollectionReference getCollection() throws Exception;
}
